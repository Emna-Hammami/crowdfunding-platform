        ...
        <div className="relative">
            ...
            <div className="relative bg-opacity-75 backgroundMain">
                ...
                <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full
                        lg:max-w-screen-xl md:px-24 lg:py-20">
                            <div className="flex flex-col items-center justify-between xl:flex-row">
                                <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                                    ...
                                    Crypto King is a decentralized crowdfunding platform where users fund blockchain projects and trade tokens securely.
                                    </p>
                                    <a href="/" aria-label=""
                                    ...
                                    <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                                        ...
                                        <form>
                                            ...
                                            <div className="mb-1 sm:mb-2">
                                                ...
                                                <input onChange={(e) => setCampaign({
                                                    ...campaign, description: e.target.value,
                                            ...
                                            <div className="mb-1 sm:mb-2">
                                                ...
                                                <input onChange={(e) => setCampaign({
                                                    ...campaign, amount: e.target.value,
                                                    })} placeholder="amount" required type="text"
                                                    className="flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white
                                                    border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-accent-400
                                                    focus:outline-none focus:shadow-outline"
                                                    id="email" name="email"/>
                                            ...
                                            <div className="mb-1 sm:mb-2">
                                                ...
                                                <input onChange={(e) => setCampaign({
                                                    ...campaign, deadline: e.target.value,
                                            ...
                                            <div className="mt-4 mb-2 sm:mb-4">
                                                <button onClick={(e) => createNewCampaign(e)} type="submit"
